...
function Car(color, brand, seats) {
  Vehicle.call(this, 'car', 'Blue', 4); //first step to bind Car and Vehicle
  this.brand = brand;
  this.seats = seats;
}

Car.prototype = Object.create(Vehicle.prototype);//Second step to get access of prototypal method of Vehicle
